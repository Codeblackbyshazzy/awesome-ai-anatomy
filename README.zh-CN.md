...
**我们读了 250 万行 AI Agent 源代码，这样你就不用读了。10 个项目，逐一解剖。有的藏了宠物系统，有的安全等于裸奔，所有项目都有 God Object。**
...
> 10 份 AI Agent 源代码深度分析——从编排框架到编程助手。

| # | 项目 | Stars | 语言 | 代码行数 | 关键发现 | 状态 |
|---|------|-------|------|---------|---------|------|
| 001 | [**Dify**](dify/) | 136K ⭐ | Python + TS | 1.24M | `graphon` 引擎、7+ 容器、30+ 向量数据库 | ✅ 已发布 |
| 002 | [**DeerFlow**](deer-flow/) | 58K ⭐ | Python + TS | — | 14 层中间件、hash 循环 kill@5、无 RBAC | ✅ 已发布 |
| 003 | [**MiroFish**](mirofish/) | 50K ⭐ | Python + Vue | 39K | LLM 社交模拟冒充"集体智慧" | ✅ 已发布 |
| 004 | [**Goose**](goose/) | 37K ⭐ | Rust + TS | 198K | MCP-first 总线、5 级 Inspector Pipeline、30+ LLM | ✅ 已发布 |
| 005 | [**Pi Mono**](pi-mono/) | 32K ⭐ | TypeScript | 147K | 游戏引擎架构、伪装成 Claude Code 的隐身模式 | ✅ 已发布 |
| 006 | [**Lightpanda**](lightpanda-browser/) | 27K ⭐ | Zig + Rust | 91K | 为 AI Agent 从零造的浏览器、比 Chrome 快 9 倍 | ✅ 已发布 |
| 007 | [**Hermes Agent**](hermes-agent/) | 26K ⭐ | Python | 260K | 自进化 Skill、FTS5 搜索、冻结内存 | ✅ 已发布 |
| 008 | [**oh-my-claudecode**](oh-my-claudecode/) | 24K ⭐ | TypeScript | 194K | 19 个 Agent 通过文件 IPC 协作、Haiku→Opus 路由 | ✅ 已发布 |
| 009 | [**Guardrails AI**](guardrails-ai/) | 6.6K ⭐ | Python | 18K | Validator Hub、reask 自修正循环 | ✅ 已发布 |
| 010 | [**Claude Code**](claude-code/) | 109K ⭐ | TypeScript | 510K | 4 层 Context、隐藏的宠物系统（18 个物种） | ✅ 已发布 |
...
我们维护了一份详细的 **[COMPARISON.md](COMPARISON.md)**，对 10 个项目进行横向分析：
...
视频讲解即将上线——关注 [@justboy1987](https://x.com/justboy1987) 获取更新。
...
我们已经发布了 10 篇深度拆解，覆盖 250 万行源代码。下一批 10 篇已经在路上了。

- 🐦 Twitter: [@justboy1987](https://x.com/justboy1987) — Teardown 线程和发现
...
<p align="center">
  <i>读了 250 万行代码。拆了 10 个项目。每周更新。<br>如果你在做 AI Agent，你应该知道最好的那些到底是怎么造的。</i>
</p>
